...
merged_data =pd.read_csv('Data/merged_gdp_country_details.csv')
all_data= pd.read_csv('Data/all.csv')

#only keep iso cols
all_data = all_data[['alpha-3', 'alpha-2']]
#merge data_sets
...
final_data.to_csv('Data/merged_gdp_country_details.csv', index=False)
